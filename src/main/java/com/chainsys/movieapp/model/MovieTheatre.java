...
public class MovieTheatre {
	...
	public String toString() {
		return "MovieTheatre [movieTheatreId=" + getMovieTheatreId() + ", movieId=" + getMovieId() + ", theatreId="
				+ getTheatreId() + ", active=" + getActive() + ", price=" + getPrice() + ", movieTiming="
				+ getMovieTiming() + ",theatreImageUrl=" + getTheatreImageUrl() + ",theatreName=" + getTheatreName()
	...
	/**
	 * @param theatreImageUrl
	 *            the theatreImageUrl to set
	 */
